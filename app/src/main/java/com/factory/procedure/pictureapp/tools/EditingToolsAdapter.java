package com.factory.procedure.pictureapp.tools;
...
import com.factory.procedure.pictureapp.R;
...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel(R.string.brush, R.drawable.ic_brush, ToolType.BRUSH));
        mToolList.add(new ToolModel(R.string.text, R.drawable.ic_text, ToolType.TEXT));
        mToolList.add(new ToolModel(R.string.eraser, R.drawable.ic_eraser, ToolType.ERASER));
